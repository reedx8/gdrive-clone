...
// Clerk webhook to handle user creation and org membership -- listens to events
// (see clerk dashboard -> configure -> webhooks -> click on/create an endpoint -> subscribe to events to enable below)
// The following run internal actions we defined in users.ts
http.route({
            ...
            switch (result.type) {
                case 'user.created':
                    ...
                    await ctx.runMutation(internal.users.createUser, {
                        ...
                        // CLERK_HOSTNAME: see convex dashboard -> settings -> environment variables
                ...
                case 'organizationMembership.created':
                    await ctx.runMutation(internal.users.addOrgIdToUser, {
                        ...
                        // tokenIdentifier: `https://magical-midge-22.clerk.accounts.dev|${result.data.public_user_data.user_id}`,
